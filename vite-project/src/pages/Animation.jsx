...
export default function Animation() {
  ...
  function ballClicked(btn) {
    ...
    if (ballRef.current) {
      ...
      if (curelected.includes("human")) imageUrl = "url('./images/human.png')";
      if (curelected.includes("cartoon")) imageUrl = "url('./images/cartoon.jpg')";
      if (curelected.includes("logo")) imageUrl = "url('./images/logo.jpgg')";
    ...
    <div style={{ margin: "auto", width: "fit-content", border: "1px solid black", borderRadius: "1rem", padding: "1rem" }}>
      <div
        ...
        style={{
          ...
          backgroundImage: "url(./images/filed.jpg)",
